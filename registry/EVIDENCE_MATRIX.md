...
| RF-0002 | `marceloroldao/resolutive-routing` | Public | GitHub prerelease `v0.2.0-rc1` is tagged exactly at `17bf787d92589ad398bf9f65c1eecbbbbde8f6b1`: C++20 deterministic router, Python/C++ parity, cumulative exclusion/reroute, authenticated MA2A failure adapter, routing contract v0.2, green Python 3.10–3.13 and assertion-enabled C++ CI | v0.1 DOI `10.5281/zenodo.22235924`; v0.2.0-rc1 DOI `10.5281/zenodo.22866104` | A | Preserve exact tag/DOI/source-test mapping for later stable releases; independent validation remains separate from archival status. |
| MA2A-0001 | `marceloroldao/ma2a` + prior RFC in `memoria.ia` | Public | GitHub prerelease `v0.2.0-rc1` is tagged exactly at `22846a55bc9dffdec8e8cf18aa51e3ea6756fac0`; it adds RFC v0.2, pinned routing boundary, native C++20 execution path and frozen resilient-execution contract | v0.1 DOI `10.5281/zenodo.22048589`; v0.2.0-rc1 DOI `10.5281/zenodo.22866124` | A/B | Preserve the v0.1 disclosure history and use the v0.2 DOI as later implementation evidence rather than rewriting the original disclosure version. |
| MA2A-0002 | `marceloroldao/ma2a` | Public | v0.1 deterministic synchronization evidence plus v0.2 candidate `22846a55bc9dffdec8e8cf18aa51e3ea6756fac0`: real `resolutive-routing` integration, deterministic B→C→D failover, cumulative exclusions, route-vs-attempt exhaustion, assertion-enabled 17-test C++ gate and 30,000-request stress run with zero observed divergences | v0.1 DOI `10.5281/zenodo.22048589`; v0.2.0-rc1 DOI `10.5281/zenodo.22866124` | A/B | Preserve the stress artifact, exact routing SHA and v0.2 archive as reproducibility evidence for later disclosure revisions. |
| MA2A-0003 | `marceloroldao/ma2a` | Public | v0.1 Ed25519 PKI/admission lineage plus v0.2 candidate `22846a55bc9dffdec8e8cf18aa51e3ea6756fac0`: signed `JobRequest`/`JobResult`/`FailureNotice`, per-target re-signing, malformed/oversized/forged-input adversarial gate, bounded TCP deadlines and `security/SECURITY_REVIEW_v0.2.md` | v0.1 DOI `10.5281/zenodo.22048589`; v0.2.0-rc1 DOI `10.5281/zenodo.22866124` | A/B | Production channel security, PKI-bound key resolution, persistent replay protection and independent external audit remain open beyond this archived RC. |
